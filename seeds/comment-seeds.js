...
const commentdata = [
    {
      comment_text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut accumsan magna sem, ac elementum',
      user_id: 6,
      post_id: 1
    },
    {
      comment_text: 'Nulla facilisi. Sed tincidunt tempus mi, ac bibendum quam suscipit vitae.',
      user_id: 6,
      post_id: 8
    },
    {
      comment_text: 'Integer ut molestie libero. In eleifend orci eu venenatis suscipit. ',
      user_id: 3,
      post_id: 10
    },
    {
      comment_text: 'Duis ac erat tincidunt, egestas lacus non, posuere ligula.',
      user_id: 3,
      post_id: 18
    },
    {
      comment_text: 'In eleifend orci eu venenatis suscipit. Morbi fringilla tempor mauris, sed aliquet nunc volutpat vel.',
      user_id: 7,
      post_id: 5
    },
    {
    ...
    {
      comment_text: 'Duis porttitor, odio quis consequat sagittis, erat justo ullamcorper lacus, consectetur aliquet leo felis vel leo. Morbi quis elementum mauris. ',
      user_id: 6,
      post_id: 7
    },
    {
      comment_text: 'Morbi at nibh id erat sollicitudin fermentum nec consectetur nisi. ',
      user_id: 7,
      post_id: 4
    },
    {
      comment_text: '. faucibus ac dapibus a, finibus at dui. Vivamus vel sapien id eros',
      user_id: 6,
      post_id: 12
    },
    {
      comment_text: 'Mauris varius eu lorem ac vestibulum. ',
      user_id: 6,
      post_id: 20
    },
    {
      comment_text: ' Proin quam lorem, ultricies sed tortor non, laoreet egestas orci. ',
      user_id: 3,
      post_id: 14
    },
    {
      comment_text: 'Proin varius, diam a consectetur laoreet, neque quam iaculis arcu, a faucibus nisl metus eget neque. Vestibulum sit amet feugiat dolor. Quisque faucibus magna non nibh eleifend ultrices. In rhoncus nisl quis dui cursus fringilla',
      user_id: 5,
      post_id: 4
    },
    {
